...
#include "../lib/dacap/obs/connection.h"
#include "../lib/dacap/obs/signal.h"
...
class Dob_st
{
    ...
    using Signal = obs::fast_signal<void(Rng&)>;
    ...
    static constexpr const char* C_LIB_NAME = "dacap observable st";
    static constexpr const char* C_LIB_SOURCE_URL = "https://github.com/dacap/observable";
    static constexpr const char* C_LIB_FILE = "benchmark_dob_st";
